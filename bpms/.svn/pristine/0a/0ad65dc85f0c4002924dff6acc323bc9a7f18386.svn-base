    ...
    createClass(Gantt, [{
        ...
        value: function setup_gantt_dates() {
            ...
            if (this.view_is(['Quarter Day', 'Half Day'])) {
                ...
                this.gantt_end = date_utils.add(this.gantt_end, 9, 'month');
            } else {
...
//            this.bind_bar_events();
        ...
        value: function get_date_info(date, last_date, i) {
            ...
            var date_text = {
                ...
                Week_lower: date.getMonth() !== last_date.getMonth() ? date_utils.format(date, 'MMM D') : date_utils.format(date, 'D'),
                Month_lower: date_utils.format(date, 'MMMM'),
                'Quarter Day_upper': date.getDate() !== last_date.getDate() ? date_utils.format(date, 'MMM D') : '',
