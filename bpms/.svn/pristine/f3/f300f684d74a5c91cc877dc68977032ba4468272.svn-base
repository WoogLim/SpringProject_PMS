	...
	<div class="modal-dialog modal-md">
		<div class="modal-content">
			<div class="modal-body">
				...
				<div class="modal__header">일감유형 삭제</div>
				<form action="${pageContext.request.contextPath }/admin/work/customInfoDelete.do" method="post" id="removeForm">
					...
					<input type='hidden' name="groupCode" value="WT">
        ...
        <div class="modal-content">
            <div class="modal-body">
				...
				<form id="customForm" action="${pageContext.request.contextPath }/admin/work/customInfoInsert.do" method="post">
					...
					<input type="hidden" name="groupName" value="일감 유형">
	                ...
	                <div class="common-modalcontent">
	                    ...
	                    <div class="common-iconselect mb-4">
	                        <label for="icon-style1" class="common-iconlabel"><i class="fas fa-plus-square"></i></label>
	                        <input type="radio" name="icon" id="icon-style1" class="common-iconbtn" value="fas fa-plus-square" onchange="iconselect(this)">
	
	                        <label for="icon-style2" class="common-iconlabel"><i class="fas fa-plus-circle"></i></label>
	                        <input type="radio" name="icon" id="icon-style2" class="common-iconbtn" value="fas fa-plus-circle" onchange="iconselect(this)">
	
	                        <label for="icon-style3" class="common-iconlabel"><i class="fas fa-exclamation-triangle"></i></label>
	                        <input type="radio" name="icon" id="icon-style3" class="common-iconbtn" value="fas fa-exclamation-triangle" onchange="iconselect(this)">
	                        ...
	                        <label for="icon-style6" class="common-iconlabel"><i class="fas fa-code"></i></label>
	                        <input type="radio" name="icon" id="icon-style6" class="common-iconbtn" value="fas fa-code" onchange="iconselect(this)">
	                        ...
	                        <label for="icon-style8" class="common-iconlabel"><i class="fas fa-chart-pie"></i></label>
	                        <input type="radio" name="icon" id="icon-style8" class="common-iconbtn" value="fas fa-chart-pie" onchange="iconselect(this)">
	                        ...
	                        <label for="icon-style14" class="common-iconlabel"><i class="fas fa-parachute-box"></i></label>
	                        <input type="radio" name="icon" id="icon-style14" class="common-iconbtn" value="fas fa-parachute-box" onchange="iconselect(this)">
	                        ...
	                        <label for="icon-style16" class="common-iconlabel"><i class="fas fa-paperclip"></i></label>
	                        <input type="radio" name="icon" id="icon-style16" class="common-iconbtn" value="fas fa-paperclip" onchange="iconselect(this)">
	                        ...
	                        <label for="icon-style18" class="common-iconlabel"><i class="fas fa-times-circle"></i></label>
	                        <input type="radio" name="icon" id="icon-style18" class="common-iconbtn" value="fas fa-times-circle" onchange="iconselect(this)">
	
	                        <label for="icon-style19" class="common-iconlabel"><i class="far fa-times-circle"></i></label>
	                        <input type="radio" name="icon" id="icon-style19" class="common-iconbtn" value="far fa-times-circle" onchange="iconselect(this)">
	
	                        <label for="icon-style20" class="common-iconlabel"><i class="fas fa-sort-amount-up"></i></label>
	                        <input type="radio" name="icon" id="icon-style20" class="common-iconbtn" value="fas fa-sort-amount-up" onchange="iconselect(this)">
	
	                        <label for="icon-style21" class="common-iconlabel"><i class="fas fa-sort-amount-down"></i></label>
	                        <input type="radio" name="icon" id="icon-style21" class="common-iconbtn" value="fas fa-sort-amount-down" onchange="iconselect(this)">
	                        ...
	                        <label for="icon-style23" class="common-iconlabel"><i class="fas fa-bullhorn"></i></label>
	                        <input type="radio" name="icon" id="icon-style23" class="common-iconbtn" value="fas fa-bullhorn" onchange="iconselect(this)">
