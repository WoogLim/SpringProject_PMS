 ...
 */
@Repository
public interface AdminIssueDAO {
	...
	/**
	 * 파라미터로 받은 pagingVO의 searchDetail조건에 맞는 이슈 담당자를 모두 조회 담당자 별 구분을 위해 사용
	 * 
	 * @param pagingVO
	 * @return
	 * 
	 ...
	 *         </pre>
	 */
	public List<IssueVO> selectIssueDirectorList(PagingVO<IssueVO> pagingVO);
	 ...
	 *         </pre>
	 */
	public List<IssueVO> selectBoardWriterList(PagingVO<IssueVO> pagingVO);
	 ...
	 * </pre>
	 */
	public List<IssueVO> selectIssueByState();
