...
<c:set value="${authMember.memImg }" var="memImg"/>
	...
	<div class="nav-top">
		<div class="container d-flex flex-row">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="${pageContext.request.contextPath }/user/main" class="logo">
			...
			<nav class="navbar navbar-header navbar-expand-lg" data-background-color="blue2">
				...
				<div class="container-fluid">
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
						...
						<!-- 메신저 -->
						<li class="nav-item">
							<a class="nav-link quick-sidebar-toggler" href="#" id="messageDropdown"
		...
		<div class="container">
			...
			<ul class="nav page-navigation page-navigation-info bg-white main-navitems">
				<ul class="nav-container">
					<li class="nav-item main-navigation usernav-active">
						<button class="project-navbtn usermain-navbtn userbtn-active">
							<i class="fas fa-tasks"></i>
							프로젝트
						</button>
					</li>
					<li class="nav-item main-navigation">
						<button class="history-navbtn usermain-navbtn">
					...
					<c:if test="${authMember.memRole eq 'ROLE_ADMIN' }">
						<li class="nav-item main-navigation">
							<button class="manage-navbtn usermain-navbtn" onclick="goAdminMainPage()">
				...
				<li class="logon-member">
					<span class="usermem-name no-drag">${authMember.memName } [${authMember.memId }]</span>
					<span>님 어서오세요</span>
					<button class="userlogout-btn" onclick="location.href='${pageContext.request.contextPath}/login/logout.do'">
						로그아웃
					</button>
				</li>
			</ul>
